...
namespace Domain.Interfaces
{
    public interface IRegistrationRepository
    {
        ...
        Task<List<Registration>> ListByStudentAsync(int studentId, CancellationToken ct = default);
        Task<List<Registration>> ListBySubjectAsync(int subjectId, CancellationToken ct = default);
